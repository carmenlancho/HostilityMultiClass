...
def hostility_measure_multiclass(sigma, X, y, k_min, seed=0):
    ...
    :return: host_instance_by_layer - df with hostility instance values per layer (cols are number of clusters per layer, rows are points)
             ...
             results_per_class - Pairwise hostility per classes. Rows: who is receiving hostility, columns: who is giving hostility (% of points from a class giving hostility to the class determined by the row)
